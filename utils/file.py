...
def save_dict_as_json(data: dict, path: str = os.getcwd() + '/data/',
...
class FileEdit:
    ...
    def open_files(self, file_extension='json'):
        files_used, _ = QFileDialog.getOpenFileNames(self.parent, '', getcwd())
        return files_used
